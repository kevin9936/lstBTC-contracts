...
/**
 * @title ConfigRegistryProxy
 * @dev Proxy contract for the configuration registry implementation
 *
 * This contract acts as a proxy for the ConfigRegistryLogic implementation,
 * allowing for upgradeable configuration management functionality. It uses OpenZeppelin's
 ...
 */
contract ConfigRegistryProxy is ERC1967Proxy {
