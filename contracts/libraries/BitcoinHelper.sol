...
/**
 * @title BitcoinHelper
 * @dev Bitcoin transaction parsing and validation library
 *
 * This library is based on the original implementation from TeleportDAO's btc-evm-bridge-contracts:
 ...
 * - Added extractTx function for enhanced transaction parsing capabilities
 */
