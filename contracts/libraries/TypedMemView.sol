...
/**
 * @title TypedMemView
 * @dev Efficient zero-copy memory view library for Solidity
 *
 * This library is based on the original implementation from Summa's memview-sol:
 * https://github.com/summa-tx/memview-sol/blob/main/contracts/TypedMemView.sol
 *
 * Original License: MIT
 * Original Author: Summa (https://summa.one)
 *
