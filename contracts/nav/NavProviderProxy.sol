...
/**
 * @title NavProviderProxy
 * @dev Proxy contract for the NAV provider implementation
 *
 * This contract acts as a proxy for the NavProviderLogic implementation,
 * allowing for upgradeable NAV (Net Asset Value) management functionality. It uses OpenZeppelin's
 ...
 */
contract NavProviderProxy is ERC1967Proxy {
