...
function printUUPSConractTable() {
  let codePathMap: Record<string, string> = {
    "BitcoinTxStoreLogic": "contracts/bitcoin-tx-store/BitcoinTxStoreLogic.sol:BitcoinTxStoreLogic",
  ...
  let proxyNameMap: Record<string, string> = {
    "BitcoinTxStoreLogic": "BitcoinTxStoreProxy",
  ...
  table.push(
    ['BitcoinTxStoreLogic', codePathMap['BitcoinTxStoreLogic'], ''],
